...
export default function Navbar() {
    return (
        <nav className="  text-cyan-400 shadow-2xl bg-slate-900 px-8 py-5  flex justify-between">
            <div className=' hover:underline hover:text-white text-4xl '>Nicholas R Taylor.com</div>
            <ul className=' text-2xl flex justify-end w-2/5'>
                <li className='hover:underline hover:text-white text-3xl mx-6'><Link href="/projects">Contact</Link></li>
